...
GLOBAL_ASYNC_QUERIES_CSV = os.getenv("GLOBAL_ASYNC_QUERIES_CSV", "False") == "True"
FEATURE_FLAGS = {
    ...
    "GLOBAL_ASYNC_QUERIES_CSV": GLOBAL_ASYNC_QUERIES_CSV,
}
...
if GLOBAL_ASYNC_QUERIES or GLOBAL_ASYNC_QUERIES_CSV:
